...
public class Deposit extends JFrame implements ActionListener{
	...
	public Deposit(){
		...
		layout.putConstraint(SpringLayout.SOUTH, textField, -24, SpringLayout.NORTH, btnDeposit);
		layout.putConstraint(SpringLayout.NORTH, btnDeposit, 122, SpringLayout.NORTH, contentPane);
		layout.putConstraint(SpringLayout.WEST, btnDeposit, 45, SpringLayout.EAST, content);
		layout.putConstraint(SpringLayout.EAST, btnDeposit, 0, SpringLayout.EAST, textField);
		...
		layout.putConstraint(SpringLayout.SOUTH, btnDeposit, -20, SpringLayout.NORTH, btnBackToMenu);
	...
	public void actionPerformed(ActionEvent e){
		...
		if(source==btnDeposit){
			//here put the code for the Deposit
				...
				try{
				    ...
				    if(rsUserId.equals(myUserId)){
				    	  ...
				    	  if(amount >=10){
				    	  	...
				    	  	PreparedStatement pstmt = con.prepareStatement("INSERT INTO deposit (amount , date_deposit , id_user , action) VALUE (?,?,?,?)");
	                        ...
	                        JOptionPane.showMessageDialog(null,"Your deposit was saved Successfully","Success",JOptionPane.INFORMATION_MESSAGE);
